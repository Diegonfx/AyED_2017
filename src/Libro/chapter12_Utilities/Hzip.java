package Libro.chapter12_Utilities;
...
import Libro.weiss.util.PriorityQueue;
...
//
// ******************PUBLIC OPERATIONS***********************
// int [ ] getCode( ch )        --> Return extraCode given character
// int getChar( extraCode )          --> Return character given extraCode
// void writeEncodingTable( out ) --> Write coding table to out
// void readEncodingTable( in ) --> Read encoding table from in
// ******************ERRORS**********************************
// Error check for illegal extraCode.
...
class HuffmanTree
{
    ...
    /**
     * Return the extraCode corresponding to character ch.
     * (The parameter is an int to accomodate EOF).
     * If extraCode is not found, return an array of length 0.
     */
    ...
    /**
     * Get the character corresponding to extraCode.
     */
